 ...
 */
class XblogImagesizemodeUpdater implements ChattyInterface, UpgradeWizardInterface
{
  ...
  private function _updatePiFlexform($row): array
  {
    ...
    $arrFlexformOrig = $arrFlexform;

    $arrFlexform['data']['image']['lDEF']['settings.flexform.pi.image.imageSizemodeList']['vDEF']   = 'plugin';
    $arrFlexform['data']['image']['lDEF']['settings.flexform.pi.image.imageSizemodeSingle']['vDEF'] = 'record';
    ...
    if ($arrFlexformOrig == $arrFlexform)
    {
      return $row;
    }
  ...
  {
    return 'PiflexformupdateXblogImagesizemode';
  }
  ...
  {
    return 'EXT:piflexformupdate: Updates the xBlog image size in list and single view';
  }
